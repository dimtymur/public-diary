...
if (empty($_GET["comm-id"]))
    redirect($dimport["post/post_page.phtml"]["redirect"]."$post_id_uri&error=invalid-comm");
...
redirect($dimport["post/post_page.phtml"]["redirect"]."$post_id_uri&success=comm-edited");
